...
class ImageNetDataset:
    ...
    def __init__(self,
        ...
        if 'train' in split:
            self.train_dataset = ImageNet(root, split='train', transform=train_transform, target_transform=target_transform)
        if 'val' in split:
            self.val_dataset = ImageNet(root, split='val', transform=test_transform, target_transform=target_transform)
