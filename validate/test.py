...
>>>>>>> ac73e5a6b6d7fcdbebd664b825b0cd0803ea9fc8
...
>>>>>>> ac73e5a6b6d7fcdbebd664b825b0cd0803ea9fc8
    ...
    metric = torchmetrics.classification.Accuracy(
        task="multiclass", num_classes=model.num_classes
    ).to(device)
    ...
    for budget in budgets:
        ...
        for noise_val in noise_vals:
            ...
            for batch, labels in tqdm(
                val_loader,
                desc=f"Testing epoch {epoch}, budget {budget}, noise: {noise_type} - {noise_val}",
            ):
...
<<<<<<< HEAD
            ...
            for batch, labels in tqdm(
                val_loader,
                desc=f"Counting flops for epoch {epoch} with budget {budget}",
            ):
=======
...
>>>>>>> ac73e5a6b6d7fcdbebd664b825b0cd0803ea9fc8
        ...
        noises = cfg.test.noises
        validating_with_noise = (
            noises is not None and len(noises) > 0 and cfg.noise != {}
        )
