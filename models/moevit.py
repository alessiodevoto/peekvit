...
class MLPMoE(MoE):
    ...
    def __init__(self, hidden_dim, mlp_dim, num_experts):
        ...
        self.experts = nn.ModuleList(
            [MLP(hidden_dim, mlp_dim) for _ in range(num_experts)]
        )
...
class AttentionMoE(MoE):
    ...
    def __init__(self, input_dim, num_heads, num_experts, dropout=0.0):
        ...
        self.experts = nn.ModuleList(
            [
                SelfAttention(input_dim, num_heads=num_heads, dropout=dropout)
...
class ViTBlockMoE(nn.Module):
    ...
    def __init__(
        ...
        self.self_attention = AttentionMoE(
            hidden_dim, num_heads, attn_num_experts, attention_dropout
        )
        ...
        self.mlp = MLPMoE(
            hidden_dim=hidden_dim, mlp_dim=mlp_dim, num_experts=mlp_num_experts
        )
