...
def train(cfg: DictConfig):
            ...
            logger.log(
                {
                    ...
                    "train/mse_loss": main_loss.detach().item(),
                }
                | add_loss_dict
            )
    ...
    def validate(model, loader, epoch):
        ...
        if hasattr(model, "set_budget"):
            ...
            mse, val_loss = validate_epoch(model, loader, epoch)
            logger.log({"val/mse": mse, "val/loss": val_loss})
